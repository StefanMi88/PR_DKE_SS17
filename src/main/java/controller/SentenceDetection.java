...
public class SentenceDetection {
    public static void main(String args[]) {
        try {
            ...
            String sentence = "Hey! This is a testing sentence from Linz! I'm curious to see if it works. Just run the file... "
            ...
            for (String s: tokens) {
            	 for(Span i: vocabSpans) {
            		 if(s.equals(tokens[i.getStart()])){
            			 ...
            			 txt.add("<token>" + s + "</token>");
            			 
            			 done=true;
            		 }
            	 }
            	 if(!done){System.out.println(s); txt.add(s);}
            	 else done=false;
            }
...
//            }
    ...
    static public ArrayList<String> getTokenizedTxt(String txt){
